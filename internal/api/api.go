...
func (a *API) Routes() http.Handler {
	...
	r.Group(func(r chi.Router) {
		...
		r.Get("/items/{itemId}/comments", a.listItemComments)
		r.Post("/items/{itemId}/comments", a.csrfRequired(a.createItemComment))
		r.Delete("/items/{itemId}/comments/{commentId}", a.csrfRequired(a.deleteItemComment))
